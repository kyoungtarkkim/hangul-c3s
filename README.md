...
Emacs 사용자들은 org를 좋아합니다! 끄적 끄적 적고 무엇인가를 적고 싶을 때, 아무래도 영문보다는 한글이 더 편하겠지요...
하지만 만일, Emacs 내부 입력기가 있다면 한영 전환 필요없이 Emacs 명령 키조합들을 빨리 빨리 처리할 수 있습니다! (~~EMACS=Esc+Meta+Alt+Contol+Shift~~)
