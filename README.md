...
- __가변 받침__을 도입하였습니다. 기존의 참신세벌식D에서 왼손의 연속 조합이 어려운 경우가 있습니다: "ㅣ+ㄱ", "ㅐ+ㄹ", "ㅛ+ㅆ", "ㅔ+ㅇ", "ㅢ+ㄴ", "ㅠ+ㅁ"의 경우, 각각 d+f, s+f, a+f, e+f, w+f, q+f로 바꾸어 칠 수도 있습니다. 또한, "ㅔ+ㅎ", "ㅢ+ㅅ", "ㅠ+ㅂ"의 경우는 각각, e+v, w+v, q+v로 바꾸어 칠 수 있습니다. 한편, "ㅡ+ㅇ", "ㅒ+ㄴ", "ㅖ+ㅁ"의 경우, 각각 c+v, x+v, z+v라 바꾸어 칠 수 있으며, "ㅡ+ㄱ", "ㅒ+ㄹ", "ㅖ+ㅆ"의 경우는 각각 c+b, x+b, z+b로 바꾸어 칠 수 있습니다.
...
1. (왼손) 기존의 참신세벌식과 참신세벌식D에서 모음 "ㅡ"는 왼손으로 타자할 때 중지를 사용해서는 속도가 나지 않으며 반드시 집게 손가락으로 쳐야 했습니다. 하지만, 참신세벌식S에서는 가변 받침이 도입되었으므로, 모음 "ㅡ"는 왼손 중지로 치는 것을 강력히 권장합니다. 이어지는 받침들은 가변 받침의 도움으로 인해 자연스러운 손가락으로 이어집니다. 사실 기존의 방법이 타자 속도와 정확성을 해치는 중요한 방해요소였기 때문에 모음 "ㅡ"를 왼손 집게 손가락으로 치지않도록 권장합니다.
