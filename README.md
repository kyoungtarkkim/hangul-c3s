...
- "***가변 받침***"을 도입하였습니다. 기존의 참신세벌식D에서 왼손의 연속 조합이 어려운 경우가 있습니다: "ㅣ+ㄱ", "ㅐ+ㄹ", "ㅛ+ㅆ", "ㅔ+ㅇ", "ㅢ+ㄴ", "ㅠ+ㅁ"의 경우, 각각 d+f, s+f, a+f, e+f, w+f, q+f로 바꾸어 칠 수도 있습니다. 또한, "ㅔ+ㅎ", "ㅢ+ㅅ", "ㅠ+ㅂ"의 경우는 각각, e+v, w+v, q+v로 바꾸어 칠 수 있습니다. 한편, "ㅡ+ㅇ", "ㅒ+ㄴ", "ㅖ+ㅁ"의 경우, 각각 c+v, x+v, z+v라 바꾸어 칠 수 있으며, "ㅡ+ㄱ", "ㅒ+ㄹ", "ㅖ+ㅆ"의 경우는 각각 c+f, x+f z+f로 바꾸어 칠 수 있습니다.
